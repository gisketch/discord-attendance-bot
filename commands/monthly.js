...
module.exports = {
    ...
    async execute(client, message, args, Discord) {
        if (args[0] && args[1]) {
            ...
            const iTestResult = new Array(Math.ceil(testInactive.length / n))
                .fill()
            ...
            if (args[1] === 'art') {
                attendanceEmbed
                    .setTitle(`Art Team Attendance Check for ${args[0]}-2021`)
                    .addFields({
                ...
                attendanceEmbed
                    .setTitle(`Dev Team Attendance Check for ${args[0]}-2021`)
                    .addFields({
